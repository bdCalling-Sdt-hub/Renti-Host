    ...
    return GetBuilder<UserListController>(
      builder: (controller) {
        ...
        return controller.userList.length == 0
            ? const Center(
                child: CustomText(text: "No User List Found!", fontSize: 18))
            : Column(
                children: List.generate(
                  controller.userList.length,
                  (index) {
                    return controller.userList[index].payment == "Completed" &&
                        controller.userList[index].requestStatus == "Completed" &&
                            controller.userList[index].userId != null &&
                            controller.userList[index].userId?.isBanned != "true"
                        ? GestureDetector(
                            onTap: () => showDialog(
                              context: context,
                              builder: (BuildContext context) => Padding(
                                ...
                                child: UserListDialogBox(
                                    ...
                                    userListResponseModel:
                                        controller.userListResponseModel),
                              ),
                            ),
                            child: Container(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                    ...
                                                    decoration: BoxDecoration(
                                                        ...
                                                        color: controller.userList[index].requestStatus == "Completed"
                                                            ? AppColors.greenLight
                                                            : controller.userList[index].carId?.tripStatus == "Start"
                                                            ? AppColors.redLight : AppColors.lightYellow),
