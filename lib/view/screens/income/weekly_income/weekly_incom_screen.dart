      ...
      child: GetBuilder<IncomeController>(
        builder: (controller) {
          ...
          return Scaffold(
            ...
            body: controller.weeklyIncomeList.isEmpty
                ? Center(
                    child: Column(
                                        ...
                                        children: [
                                          Flexible(
                                            child: CustomText(
                                              ...
                                              overflow: TextOverflow.ellipsis,
                                              text:
                                                  "${controller.incomeResponseModel.weeklyIncomeList?[index].carId?.carModelName}",
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: CustomText(
                                                text:
                                                    "${controller.incomeResponseModel.weeklyIncomeList?[index].paymentData?.balanceTransaction}",
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                fontSize: 12),
                                          ),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Flexible(
                                            child: CustomText(
                                                text:
                                                    "${controller.incomeResponseModel.weeklyIncomeList?[index].rentId?.rentTripNumber}",
                                                maxLines: 1,
                                                overflow: TextOverflow.ellipsis,
                                                fontSize: 12),
                                          ),
