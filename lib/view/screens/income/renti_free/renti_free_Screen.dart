                          ...
                          children: List.generate(
                            ...
                            (index) {
                              ...
                              String startDateString =
                                  "${controller.payment[index].income?.rentId?.startDate}";
                                                  ...
                                                  Flexible(
                                                    child: CustomText(
                                                        ...
                                                        overflow: TextOverflow
                                                            .ellipsis,
                                                        text:
                                                            " ${controller.payment[index].income?.paymentData?.balanceTransaction}",
                                                        fontSize: 12),
                                                  ),
                                                ],
                                              ),
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(
                                                          child: CustomText(
                                                              text:
                                                                  " ${controller.payment[index].income?.rentId?.rentTripNumber}",
                                                              maxLines: 1,
                                                              overflow:
                                                                  TextOverflow
                                                                      .ellipsis,
