...
class RentRequestResponseModel {
  ...
  factory RentRequestResponseModel.fromRawJson(String str) => RentRequestResponseModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RentRequestResponseModel.fromJson(Map<String, dynamic> json) => RentRequestResponseModel(
    message: json["message"],
    rentRequest: json["rentRequest"] == null ? [] : List<RentRequest>.from(json["rentRequest"]!.map((x) => RentRequest.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "message": message,
    "rentRequest": rentRequest == null ? [] : List<dynamic>.from(rentRequest!.map((x) => x.toJson())),
  };
}
...
class RentRequest {
  ...
  factory RentRequest.fromRawJson(String str) => RentRequest.fromJson(json.decode(str));
